...
class ISettings(Interface):
    ...
    enabled = schema.Bool(
        title=_("Enabled"),
        description=_(
            "If enabled, it will by default make the entire site "
    ...
    activated = schema.Set(
        ...
        description=_(
            "Select the conditions under which something can be "
    ...
    status_message = schema.Text(
        ...
        description=_(
            "An status message to be displayed to authenticated "
